...
import pigs2 from "../images/pigs.jpeg";
import { FaQuoteLeft } from "react-icons/fa";
import { FaQuoteRight } from "react-icons/fa";
import Masonry, { ResponsiveMasonry } from "react-responsive-masonry";

function PigsProject() {
    return (
        <div className='container mx-auto mt-24 px-4 sm:px-6 lg:px-8'>
            <h1 className='text-center text-amber-50 text-3xl sm:text-5xl font-bold uppercase mb-8'>Pigs Project</h1>
            {/* First description of the project */}
            <div className='flex flex-col-reverse sm:flex-row items-center justify-center mb-12'>
                <div className='sm:mr-4'>
                    <img src={pigs} alt='project thumbnail' className='rounded-lg lg:w-2/4 hover:animate-pulse' />
                </div>
            ...
            <div className='flex flex-col-reverse sm:flex-row items-center justify-center mb-24 gap-24'>
                ...
                <div className='sm:ml-4'>
                    <img src={pigs2} alt='project thumbnail' className='rounded-lg lg:w-2/4 hover:animate-pulse' />
                </div>
            </div>
            ...
            <div className='items-center mb-24 justify-center mx-auto text-center'>
                ...
                <ResponsiveMasonry columnsCountBreakPoints={{ 350: 2, 750: 3, 900: 4 }}>
                    <Masonry gutter="20px">
                        <img src={pigs} alt='chicken-pic'></img>
                        <img src={pigs2} alt='chicken-pic'></img>
                        <img src={pigs} alt='chicken-pic'></img>
                        <img src={pigs2} alt='chicken-pic'></img>
                    </Masonry>
                </ResponsiveMasonry>
